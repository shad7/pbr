...
from_pip_string = metadata.from_pip_string


class TestSemanticVersion(base.BaseTestCase):

    def test_equality(self):
        base = semantic.SemanticVersion(1, 2, 3)
        base2 = semantic.SemanticVersion(1, 2, 3)
        major = semantic.SemanticVersion(2, 2, 3)
        minor = semantic.SemanticVersion(1, 3, 3)
        patch = semantic.SemanticVersion(1, 2, 4)
        pre_base = semantic.SemanticVersion(1, 2, 3, 'a', 4)
        pre_base2 = semantic.SemanticVersion(1, 2, 3, 'a', 4)
        pre_type = semantic.SemanticVersion(1, 2, 3, 'b', 4)
        pre_serial = semantic.SemanticVersion(1, 2, 3, 'a', 5)
        dev_base = semantic.SemanticVersion(1, 2, 3, dev_count=6, githash='6')
        dev_base2 = semantic.SemanticVersion(1, 2, 3, dev_count=6, githash='6')
        dev_count = semantic.SemanticVersion(1, 2, 3, dev_count=7, githash='6')
        githash = semantic.SemanticVersion(1, 2, 3, dev_count=6, githash='7')
        ...
        simple = semantic.SemanticVersion(1)
        explicit_minor = semantic.SemanticVersion(1, 0)
        explicit_patch = semantic.SemanticVersion(1, 0, 0)
    ...
    def test_ordering(self):
        ...
        minor = semantic.SemanticVersion(1, 3, 3)
        patch = semantic.SemanticVersion(1, 2, 4)
        pre_alpha = semantic.SemanticVersion(1, 2, 3, 'a', 4)
        pre_beta = semantic.SemanticVersion(1, 2, 3, 'b', 3)
        pre_rc = semantic.SemanticVersion(1, 2, 3, 'rc', 2)
        pre_serial = semantic.SemanticVersion(1, 2, 3, 'a', 5)
        dev_base = semantic.SemanticVersion(1, 2, 3, dev_count=6, githash='6')
        dev_count = semantic.SemanticVersion(1, 2, 3, dev_count=7, githash='6')
        githash = semantic.SemanticVersion(1, 2, 3, dev_count=6, githash='7')
    ...
    def test_from_pip_string_legacy_alpha(self):
        expected = semantic.SemanticVersion(
    ...
    def test_final_version(self):
        semver = semantic.SemanticVersion(1, 2, 3)
    ...
    def test_parsing_short_forms(self):
        semver = semantic.SemanticVersion(1, 0, 0)
    ...
    def test_dev_version(self):
        semver = semantic.SemanticVersion(1, 2, 4, dev_count=5, githash='12')
    ...
    def test_dev_no_git_version(self):
        semver = semantic.SemanticVersion(1, 2, 4, dev_count=5)
        self.assertEqual((1, 2, 4, 'dev', 4), semver.version_tuple())
        self.assertEqual("1.2.4", semver.brief_string())
    ...
    def test_dev_zero_version(self):
        semver = semantic.SemanticVersion(1, 2, 0, dev_count=5)
    ...
    def test_alpha_dev_version(self):
        self.assertRaises(
            ValueError, semantic.SemanticVersion, 1, 2, 4, 'a', 1, 5, '12')

    def test_alpha_version(self):
        semver = semantic.SemanticVersion(1, 2, 4, 'a', 1)
    ...
    def test_alpha_zero_version(self):
        semver = semantic.SemanticVersion(1, 2, 0, 'a', 1)
    ...
    def test_alpha_major_zero_version(self):
        semver = semantic.SemanticVersion(1, 0, 0, 'a', 1)
    ...
    def test_alpha_default_version(self):
        semver = semantic.SemanticVersion(1, 2, 4, 'a')
    ...
    def test_beta_dev_version(self):
        self.assertRaises(
            ValueError, semantic.SemanticVersion, 1, 2, 4, 'b', 1, 5, '12')

    def test_beta_version(self):
        semver = semantic.SemanticVersion(1, 2, 4, 'b', 1)
    ...
    def test_decrement_nonrelease(self):
        ...
        semver = semantic.SemanticVersion(1, 2, 4, 'b', 1)
        self.assertEqual(
            semantic.SemanticVersion(1, 2, 3), semver.decrement())
    ...
    def test_decrement_nonrelease_zero(self):
        ...
        semver = semantic.SemanticVersion(1, 0, 0)
        self.assertEqual(
            semantic.SemanticVersion(0, 9999, 9999), semver.decrement())

    def test_decrement_release(self):
        # The next patch version of a release version requires a change to the
        # patch level.
        semver = semantic.SemanticVersion(1, 2, 5)
        self.assertEqual(
            semantic.SemanticVersion(1, 2, 6), semver.increment())
        self.assertEqual(
            semantic.SemanticVersion(1, 3, 0), semver.increment(minor=True))
        self.assertEqual(
            semantic.SemanticVersion(2, 0, 0), semver.increment(major=True))
    ...
    def test_increment_nonrelease(self):
        ...
        semver = semantic.SemanticVersion(1, 2, 4, 'b', 1)
        self.assertEqual(
            semantic.SemanticVersion(1, 2, 4, 'b', 2), semver.increment())
    ...
    def test_rc_dev_version(self):
        self.assertRaises(
            ValueError, semantic.SemanticVersion, 1, 2, 4, 'rc', 1, 5, '12')

    def test_rc_version(self):
        semver = semantic.SemanticVersion(1, 2, 4, 'rc', 1)
    ...
    def test_to_dev(self):
        self.assertEqual(
            semantic.SemanticVersion(1, 2, 3, dev_count=1, githash='foo'),
            semantic.SemanticVersion(1, 2, 3).to_dev(1, 'foo'))
        self.assertEqual(
            semantic.SemanticVersion(1, 2, 3, dev_count=1, githash='foo'),
            semantic.SemanticVersion(1, 2, 3, 'rc', 1).to_dev(1, 'foo'))

    def test_to_release(self):
        self.assertEqual(
            semantic.SemanticVersion(1, 2, 3),
            semantic.SemanticVersion(
                1, 2, 3, dev_count=1, githash='foo').to_release())
        self.assertEqual(
            semantic.SemanticVersion(1, 2, 3),
            semantic.SemanticVersion(1, 2, 3, 'rc', 1).to_release())
